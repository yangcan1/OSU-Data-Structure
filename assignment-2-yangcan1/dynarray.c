...
/*
Return 1 if the size of dynarray is empty, otherwise, return 0.
*/
int orempty(struct dynarray *da) {
  if (da->size == 0) {
    return 1;
  }
  else
...
/*
This function removes the first element stored in the dynarray.
*/